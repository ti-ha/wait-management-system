...
class MenuTests(unittest.TestCase):
    ...
    def test_add_category(self):
        ...
        self.assertIsNotNone(self.app.get_menu_category("Burgers"))

    def test_remove_category(self):
        self.app.add_menu_category("Burgers")
        self.app.remove_menu_category("Burgers")
        self.assertIsNone(self.app.get_menu_category("Burgers"))

    def test_add_menu_item(self):
        self.app.add_menu_category("Burgers")
        self.app.add_menu_item("Burgers", "Cheeseburger", 20.00, "/cheeseburger.png")
        self.assertIsNotNone(self.app.get_menu_item("Burgers", "Cheeseburger"))
    ...
    # burger = MenuItem("hamburger", 20.0, None)

    # snack = MenuItem("chips",  20.0, None)
    # drink = MenuItem("soda", 5.0, None)
